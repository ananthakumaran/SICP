...
;; The cons-stream will delay the evaluation of the second argument
;; By the time it evaluates the second argument(THE-ASSERTIONS), it will
;; be pointing a different pair(assertion, THE-ASSERTIONS) and this will
;; create a infinite stream of assertion
