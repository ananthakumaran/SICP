...
;; Here the rear-pointer is still pointing the b. This will not
;; create any problem when we try to add another item in the 
;; queue, because the empty queue will only check the front-ptr and
;; if the queue is empty both the front and the rear pointer will
;; be set to pointing the new item.
