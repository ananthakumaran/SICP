...
;; by the program, so that we could compute the number of ways to change
;; a British pound, for example. As the program is written, the knowledge
...
;; be able to supply a list of coins to be used for making change.  We
;; want to rewrite the procedure cc so that its second argument is a list
;; of the values of the coins to use rather than an integer specifying
